...
**Hᴏꜱᴛᴇᴅ ᴏɴ:** [Hᴇʀᴏᴋᴜ](https://app.koyeb.com)

**Dᴇᴠᴇʟᴏᴘᴇʀ:** [Cʀɪsᴛᴏᴘʜᴇʀ](https://t.me/Contactadowbot)

**Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ:** [Cɪɴᴇᴘʟᴇx](https://t.me/cineplexmovreq)

**Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ:** [Cɪɴᴇᴘʟᴇx](t.me/cpx_upd)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/Contactadowbot'>**Cʀɪsᴛᴏᴘʜᴇʀ** </a>

<a href=''https://t.me/Contactadowbot>Cʀɪsᴛᴏᴘʜᴇʀ</a> ɪꜱ ꜱᴜᴘᴇʀ ɴᴏᴏʙ 😎. ᴊᴜꜱᴛ ʟᴇᴀʀɴɪɴɢ ꜰʀᴏᴍ ᴏꜰꜰɪᴄɪᴀʟ ᴅᴏᴄꜱ.
...
Sᴇɴᴅ ᴍᴇ ᴀɴʏ ғɪʟᴇ I ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ᴀ ᴘᴇʀᴍᴀɴᴇɴᴛ Sʜᴀʀᴀʙʟᴇ Lɪɴᴋ.
I Sᴜᴘᴘᴏʀᴛ Cʜᴀɴɴᴇʟ Aʟsᴏ!
